...
An unique line that passes through the origin is defined by a non-zero vector where they have the same direction.

$\{t\vec{r} | t \in \mathbb{R}\}$

# line dose not pass through the origin

It can be represented by adding a vector $\vec{a}$ to a line passing through the origin. 

$\{\vec{a} + t\vec{r} | t \in \mathbb{R}\}$

‍

‍

1. [mathematical analysis - Excerpt of: Second Year Calculus From Celestial Mechanics t... (z-lib.org), p43](lt://open/lU3SfF4LrUatS6kMlGtAQA)
